import { LayoutDashboard, Users, CalendarCheck, BarChart3, MessageSquare, UserCircle, Phone, GitBranch } from "lucide-react";
...
export default async function ClientPortalLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems: CrmNavItem[] = [
    ...
    { label: "Pipeline", href: "/client/pipeline", icon: <GitBranch /> },
