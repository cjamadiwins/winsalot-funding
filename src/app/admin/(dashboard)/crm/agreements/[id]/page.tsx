...
import { renderAgreementTemplate, type CrmAgreementTemplateRow, type CrmClientAgreementRow } from "@/lib/crm-agreement-types";
...
export default async function AdminAgreementDetailPage({
  ...
  const [{ data: template }, { data: events }, { data: intakeConfig }, { data: submission }, { data: invoice }] = await Promise.all([
