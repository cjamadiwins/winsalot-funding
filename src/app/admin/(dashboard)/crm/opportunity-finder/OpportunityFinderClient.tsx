...
// Compact variant for the agent/priority-override controls embedded inside
// each card - the filter bar above keeps the roomier `inputClass`.
...
export default function OpportunityFinderClient({
  ...
  // instead of navigating to /admin/crm/opportunities/[id]. Omitted on the
  // standalone /admin/crm/opportunity-finder page, which keeps its normal
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div className="min-w-0">
                      ...
                      <div className="break-words text-[11px] text-slate-400">
                        {row.stageOrStatus} · {row.clientName || "No client"} · {row.campaignName}
                      </div>
                    </div>
                  ...
                  <div className="mt-3 grid grid-cols-2 gap-2">
                    <label className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">
                      ...
                      <select
                        ...
                        disabled={isPending}
                        className={`${cellInputClass} mt-1 normal-case`}
                      >
