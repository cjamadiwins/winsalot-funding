...
import {
  ...
  editLeadgenCompanyMessageAction,
...
// table. See src/app/admin/(dashboard)/crm/chat/page.tsx for the
// Cleaning CRM's own, fully separate copy of this page.
const scope: ChatScopeConfig = {
  ...
  editCompanyMessage: editLeadgenCompanyMessageAction,
  ...
  editDmMessage: editLeadgenDmMessageAction,
